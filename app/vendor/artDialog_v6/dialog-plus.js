define('dialog-plus', function(require, exports, module){
  ...
  $.extend(Popup.prototype, {
    ...
    __follow: function (anchor) {
      ...
      var temp = [{
        top: top - popupHeight - (this.options.offset || 0),
        bottom: top + height + (this.options.offset || 0),
        left: left - popupWidth - (this.options.offset || 0),
        right: left + width + (this.options.offset || 0)
      }, {
        top: top -(this.options.offset || 0),
        bottom: top - popupHeight + height + (this.options.offset || 0),
        left: left - (this.options.offset || 0),
        right: left - popupWidth + width + (this.options.offset || 0)
      }];
