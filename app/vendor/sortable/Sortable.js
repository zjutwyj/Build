...
define('Sortable', [], function(require, exports, module){
(function (factory) {
	"use strict";
    ...
    Est.each(['pull', 'put'], function(key){
      if (!(key in group)) {
        group[key] = true;
      }
    });
	...
	Sortable.prototype = /** @lends Sortable.prototype */ {
		...
		_prepareDragStart: function (/** Event */evt, /** Touch */touch, /** HTMLElement */target) {
			...
			if (target && !dragEl && (target.parentNode === el)) {
				...
				dragStartFn = function () {
					...
					// Disable "draggable"
          Est.each(options.ignore.split(','), function(criteria){
      ...
      Est.each(this.toArray(), function(id, i){
      ...
      Est.each(el.querySelectorAll('[draggable]'), function(el){
