...
app.addStatus('moduleConfig', [
  { text: '顶部导航', className: 'topNavigation', moduleId: 'TopNavigation', title: '顶部导航模块', width: 600, height: 400 },
  { text: '底部导航', className: 'bottomNavigation', moduleId: 'BottomNavigation', ttile: '试问导航模块', width: 600, height: 400 },
  { text: '魔方导航', className: 'cubeNavigation', moduleId: 'CubeNavigation', title: '魔方导航模块', width: 600, height: 400 },
  { text: '图文展示', className: 'rich', moduleId: 'Rich', title: '图文展示模块', width: 600, height: 400 }
]);
